...
export default class Daily extends React.Component {
  ...
  returnHourWrapperHeight() {
    const hourWrappers = document.getElementsByClassName(
      styles.dailyHourWrapper
    );
  ...
  returnHourHeaderHeight() {
    const hourHeader = document.getElementsByClassName(styles.dailyHour);
  ...
  getTimeInHours(date) {
    return (
      date.getHours() + date.getMinutes() / 60 + date.getSeconds() / 3600000
    );
  }
